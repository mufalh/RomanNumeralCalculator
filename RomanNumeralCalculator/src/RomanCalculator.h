...
#include <string.h>
#include <stdlib.h>
#ifndef SRC_ROMANCALCULATOR_H_
#define SRC_ROMANCALCULATOR_H_
...
public:
    ////////////////////////////////////////////////////////////////////////////////////////////
	string add(char Number1[10], char Number2[10])
				{
				long int DecNumber1;
		    	long int DecNumber2;
		    	long int ReDec;
	...
	/////////////////////////////////////////////////////////////////////////////////////////////
	/////////////////////////////////////////////////////////////////////////////////////////////
	string sub(char Number1[10], char Number2[10])
				    {
					long int DecNumber1;
			    	long int DecNumber2;
			    	long int ReDec;
	...
	RomanCalculator();
	virtual ~RomanCalculator();
};

} /* namespace std */

#endif /* SRC_ROMANCALCULATOR_H_ */
